...
show_help() {
    ...
    log_output "  Executa um plugin instalado ou em modo de desenvolvimento."
    log_output "  Útil para testar plugins durante o desenvolvimento sem instalá-los."
    log_output ""
    log_output "${LIGHT_GREEN}Ordem de busca:${NC}"
    log_output "  1. Busca comando no susa.lock (plugins instalados)"
    log_output "  2. Se não encontrar, tenta adicionar do diretório atual (modo dev)"
    log_output "  3. Busca novamente no susa.lock após atualização"
    log_output ""
    log_output "${LIGHT_GREEN}Argumentos:${NC}"
    log_output "  plugin-name       Nome do plugin a ser executado"
    log_output "  category          Categoria do comando no plugin"
    log_output "                    Use barras (/) para subcategorias: category/subcat"
    log_output "  command           Comando a ser executado"
    log_output "  [args...]         Argumentos adicionais para o comando"
    log_output ""
    log_output "${LIGHT_GREEN}Opções:${NC}"
    log_output "  -h, --help        Mostra esta mensagem de ajuda"
    log_output "  -v, --verbose     Habilita saída detalhada para depuração"
    log_output "  --prepare         Apenas adiciona plugin ao registry/lock sem executar"
    log_output "  --cleanup         Apenas remove plugin dev do registry/lock"
    log_output "  --                Separa opções do run de argumentos do plugin"
    log_output ""
    log_output "${LIGHT_GREEN}Exemplos:${NC}"
    log_output "  # Executar comando de plugin instalado"
    log_output "  susa self plugin run my-plugin text hello"
    log_output ""
    log_output "  # Executar comando em subcategoria"
    log_output "  susa self plugin run my-plugin text/examples hello"
    log_output ""
    log_output "  # Executar plugin em desenvolvimento no diretório atual"
    log_output "  cd ~/meu-plugin"
    log_output "  susa self plugin run meu-plugin text comando"
    log_output ""
    log_output "  # Passar argumentos do plugin que conflitam com opções do run"
    log_output "  susa self plugin run my-plugin text hello -- --help --verbose"
    log_output ""
    log_output "  # Apenas preparar plugin dev (adicionar ao registry/lock)"
    log_output "  cd ~/meu-plugin"
    log_output "  susa self plugin run --prepare meu-plugin text comando"
    log_output ""
    log_output "  # Remover plugin dev do registry/lock"
    log_output "  susa self plugin run --cleanup meu-plugin text comando"
    log_output ""
    log_output "${LIGHT_GREEN}Modo de desenvolvimento:${NC}"
    log_output "  Para testar um plugin em desenvolvimento:"
    log_output ""
    log_output "  ${BOLD}Modo automático (com cleanup):${NC}"
    log_output "  1. Navegue até o diretório do plugin"
    log_output "  2. Execute: susa self plugin run <plugin-name> <category> <command>"
    log_output "  3. O plugin será temporariamente adicionado ao lock"
    log_output "  4. Após execução, será automaticamente removido"
    log_output ""
    log_output "  ${BOLD}Modo manual (sem cleanup automático):${NC}"
    log_output "  1. susa self plugin run --prepare meu-plugin text cmd    # Adiciona ao lock"
    log_output "  2. susa meu-plugin text cmd                              # Executa normalmente"
    log_output "  3. susa meu-plugin text outro-cmd                        # Executa outro comando"
    log_output "  4. susa self plugin run --cleanup meu-plugin text cmd    # Remove do lock"
    log_output ""
    ...
    log_output "      comando1/"
    log_output "        config.yaml       # Configuração do comando"
    log_output "        main.sh           # Script do comando"
    log_output "      subcategoria/       # Subcategorias (acessadas com /)"
    log_output "        config.yaml"
    log_output "        comando2/"
    log_output "          config.yaml"
    log_output "          main.sh"
    log_output "    categoria2/           # Múltiplas categorias"
    log_output "      config.yaml"
    log_output "      ..."
    log_output ""
    log_output "${LIGHT_GREEN}Uso de Subcategorias:${NC}"
    log_output "  Para comandos em subcategorias, use barra (/) para indicar a hierarquia:"
    log_output ""
    log_output "  Estrutura:"
    log_output "    plugin/categoria/subcategoria/comando/"
    log_output ""
    log_output "  Execução:"
    log_output "    susa self plugin run plugin-name categoria/subcategoria comando"
    log_output ""
    log_output "  Exemplo:"
    log_output "    susa self plugin run tools database/admin migrate"
}
